...
public class SaltAES256 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String responseDecrypt=SaltAES256.decrypt("kVPLM6a6m9irzv5a9Y1yPzRaSu1ScpFdamApAve/NZZmOMbIkPvHGnf2DAndKv2q6Zyd/swYkWSVWcmAbGpY1g==");
			// System.out.println(originalString);
			System.out.println("enc  ===   " + encryptedString);
			System.out.println("dec ====== "+responseDecrypt);
